...
class GetClassifiedTrainingData(Resource):
    ...
    def get(self, user_id, topic_name):
        ...
        return nlp_services.get_classified_data(user_id, topic_name), {'Access-Control-Allow-Origin': '*'}
...
class GetUnclassifiedTrainingData(Resource):
    ...
    def get(self, user_id, topic_name):
        ...
        return nlp_services.get_unclassified_data(user_id, topic_name), {'Access-Control-Allow-Origin': '*'}
...
class GetAllTrainingData(Resource):
    ...
    def get(self, user_id, topic_name):
        ...
        return nlp_services.get_all_training_data(user_id, topic_name), {'Access-Control-Allow-Origin': '*'}
